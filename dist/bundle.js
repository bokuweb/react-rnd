      ...
      return _react2['default'].createElement(
        _src2['default'],
        {
          ...
          onResizeStop: function () {
            return console.log('resize stop');
          },
...
},{"../../src":164,"react":162}],2:[function(require,module,exports){
'use strict';
...
},{"./example":1,"react":162,"react-dom":3}],3:[function(require,module,exports){
'use strict';
...
},{"react":162,"react-dom":3}],5:[function(require,module,exports){
'use strict';
...
var Risizable = (function (_Component) {
  ...
  _createClass(Risizable, [{
    key: 'onResizeStart',
    value: function onResizeStart(direction, _ref) {
    ...
    value: function onMouseMove(_ref2) {
      ...
      if (this.props.onResize) this.props.onResize({ width: this.state.width, height: this.state.height });
    }
  }, {
    key: 'onMouseUp',
    ...
    value: function render() {
      ...
      return _react2['default'].createElement('div', { ref: 'resizable',
        style: (0, _reactLibObjectAssign2['default'])({ position: "relative" }, this.props.customStyle, style),
...
},{"./resizer":6,"react":162,"react/lib/Object.assign":28}],6:[function(require,module,exports){
'use strict';
...
var ResizableAndMovable = (function (_Component) {
  ...
  function ResizableAndMovable(props) {
    ...
    _get(Object.getPrototypeOf(ResizableAndMovable.prototype), 'constructor', this).call(this, props);
  ...
  _createClass(ResizableAndMovable, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'div',
          { style: { width: width + 'px', height: height + 'px', cursor: "move" } },
          _react2['default'].createElement(
...
},{"react":162,"react-draggable":4,"react-resizable-box":5,"react/lib/Object.assign":28}]},{},[2]);
